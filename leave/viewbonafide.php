...
<!-- Links (sit on top) -->
    ...
    $sql="SELECT * from bonafideform where prn = '$prn' ";
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-row m-b-55">
                            <div class="name">Date of application</div>
                            <div class="value">
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc" >
                                            <input class="input--style-5" style="width: 496px"; 
                                            type="Date" 
                                             name="date" value="<?php echo $row['date'] ?>" readonly="">
                                            <label class="label--desc"></label>
                                        </div>
                                    </div>
                                </div>
...
$sql="INSERT INTO accepted_bonafide (`firstname`,`lastname`,`branch`,`class`,`rollno`,`prn`,`number`,`date`,`reason`,`status`)
  VALUES ('$firstname','$lastname','$branch','$class','$rollno','$prn','$number','$date','$reason','$status')";
...
$sql1="delete from bonafideform where prn='$prn' ";
...
$sql="INSERT INTO deny_bonafide (`firstname`,`lastname`,`branch`,`class`,`rollno`,`prn`,`number`,`date`,`reason`,`status`)
  VALUES ('$firstname','$lastname','$branch','$class','$rollno','$prn','$number','$date','$reason','$status')";
